...
a&&(b=e,d&&0<c.toString().length&&u(g,7,c.toString())));d=b.toString();a=d.length;if(2>a)throw Error("The string supplied is too short to be a phone number");if(17<a)throw Error("The string supplied is too long to be a phone number");if(1<d.length&&"0"==d.charAt(0)){u(g,4,!0);for(a=1;a<d.length-1&&"0"==d.charAt(a);)a++;1!=a&&u(g,8,a)}u(g,2,parseInt(d,10));return g}function O(a,b){return(a="string"==typeof a?b.match("^(?:"+a+")$"):b.match(a))&&a[0].length==b.length?!0:!1};k("phoneNumberUtils",{});k("phoneNumberUtils.formatNumber",function(a,b,c){try{var d=K.g(),e=Z(d,a,b),g=Pa(d,e);return 0==g||4==g?Ma(d,e,"undefined"==typeof c?0:c):a}catch(f){return a}});k("phoneNumberUtils.getExampleNumber",function(a,b,c){try{var d=K.g();a:{if(Q(a)){var e=V(U(d,a),c);try{if(null!=e.g[6]){var g=t(e,6);var f=Sa(d,g,a,!1);break a}}catch(h){}}f=null}return Ma(d,f,b?2:1)}catch(h){return""}});k("phoneNumberUtils.getExtension",function(a,b){try{return t(Z(K.g(),a,b),3)}catch(c){return""}});
k("phoneNumberUtils.getNumberType",function(a,b){try{var c=K.g();var d=Z(c,a,b),e=Oa(c,d),g=S(c,y(d,1),e);if(null==g)var f=-1;else{var h=R(d);f=W(h,g)}return f}catch(l){return-99}});
k("phoneNumberUtils.getValidationError",function(a,b){try{var c=K.g(),d=Z(c,a,b);return Pa(c,d)}catch(e){return"Invalid country calling code"==e.message?1:"Phone number too short after IDD"==e.message||"The string supplied is too short to be a phone number"==e.message?2:"The string supplied is too long to be a phone number"==e.message?3:-99}});
k("phoneNumberUtils.isValidNumber",function(a,b){try{var c=K.g(),d=Z(c,a,b);var e=Oa(c,d),g=y(d,1),f=S(c,g,e),h;if(!(h=null==f)){var l;if(l="001"!=e){var z=U(c,e);if(null==z)throw Error("Invalid region code: "+e);var M=y(z,10);l=g!=M}h=l}if(h)var wa=!1;else{var Ta=R(d);wa=-1!=W(Ta,f)}return wa}catch(Ua){return!1}});k("phoneNumberUtils.numberFormat",{E164:0,INTERNATIONAL:1,NATIONAL:2,RFC3966:3});
k("phoneNumberUtils.numberType",{FIXED_LINE:0,MOBILE:1,FIXED_LINE_OR_MOBILE:2,TOLL_FREE:3,PREMIUM_RATE:4,SHARED_COST:5,VOIP:6,PERSONAL_NUMBER:7,PAGER:8,UAN:9,VOICEMAIL:10,UNKNOWN:-1});k("phoneNumberUtils.validationError",{IS_POSSIBLE:0,INVALID_COUNTRY_CODE:1,TOO_SHORT:2,TOO_LONG:3,IS_POSSIBLE_LOCAL_ONLY:4,INVALID_LENGTH:5});})();
...
(() => {
"use strict";
/* unused harmony export smartPhoneInput */
/* harmony import */ var _scripts_i18n_phonenumbers_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6374);
/* harmony import */ var _scripts_i18n_phonenumbers_min_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scripts_i18n_phonenumbers_min_js__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _smart_input_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8588);
/* harmony import */ var _smart_input_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_smart_input_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _smart_countryinput_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3738);
/* harmony import */ var _smart_countryinput_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_smart_countryinput_js__WEBPACK_IMPORTED_MODULE_5__);
...
class smartPhoneInput extends Smart.Component {
	get name() {
