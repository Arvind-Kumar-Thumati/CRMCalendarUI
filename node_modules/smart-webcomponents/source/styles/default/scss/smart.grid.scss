...
.smart-grid {
  ...
  &[grouped] {
    ...
    smart-grid-row {
      &[group] {
        &:not([summary])>.smart-grid-cell-container>smart-grid-cell .smart-label {
          align-items: center;
          padding: 0px;
          padding-top: calc(var(--smart-grid-group-row-vertical-offset) * 1px);
        }

        &[summary]>.smart-grid-cell-container>smart-grid-cell div[content] {
          border-top: none;
          background: var(--smart-surface);
          color: var(--smart-surface-color);
        }
        ...
        >.smart-grid-cell-container {
          ...
          >smart-grid-cell[has-toggle-button] div[content] {
        ...
        &[level="1"]>.smart-grid-cell-container>smart-grid-cell div[content] {
          background: var(--smart-surface);
        }

        &[level="2"]>.smart-grid-cell-container>smart-grid-cell div[content] {
          background: var(--smart-surface);
        }
      }
      ...
      &:not([leaf])[group] {
        >.smart-grid-cell-container>smart-grid-cell:not(.smart-grid-column-border) {
      ...
      &[summary] {
        >.smart-grid-cell-container>smart-grid-cell {
          color: var(--smart-surface-color);
          font-size: 9px;
          font-weight: 500;
          opacity: 0.75;
        ...
        &[selected]>.smart-grid-cell-container>smart-grid-cell {
          color: var(--smart-ui-state-color-selected);
        }

        &[group]>.smart-grid-cell-container>smart-grid-cell div[content] {
          border-top-left-radius: 0px;
          border-top-right-radius: 0px;
          border-bottom-left-radius: 0px;
          border-bottom-right-radius: 0px;
  ...
  &[appearance_show-row-header-select-icon][selection_enabled][selection_allow-row-header-selection] {
    smart-grid-row smart-grid-cell[header] {
...
smart-grid-row {
  ...
  &[alternation-index="0"] smart-grid-cell:not([selected]):not([header]):not([update]):not([delete]):not([add]):not([freeze]) .smart-label {
    background-color: var(--smart-background);
    color: var(--smart-background-color);
    border-color: var(--smart-border);
  }

  &[alternation-index="1"] smart-grid-cell:not([selected]):not([header]):not([update]):not([delete]):not([add]):not([freeze]) .smart-label {
  ...
  &[alternation-index="2"] smart-grid-cell:not([selected]):not([header]):not([update]):not([delete]):not([add]):not([freeze]) .smart-label {
  ...
  &[alternation-index="3"] smart-grid-cell:not([selected]):not([header]):not([update]):not([delete]):not([add]):not([freeze]) .smart-label {
  ...
  &[alternation-index="4"] smart-grid-cell:not([selected]):not([header]):not([update]):not([delete]):not([add]):not([freeze]) .smart-label {
...
smart-grid-cell {
  ...
  &[selected] {
    ...
    &[freeze]:not([editor]):not([rowspan]):not([colspan]) {
      opacity: 1;
